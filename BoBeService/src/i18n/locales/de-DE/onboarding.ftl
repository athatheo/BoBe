...
onboarding-local-tier-small-description = Schnell, braucht wenig Ressourcen. Ideal für kurze Interaktionen.
...
setup-step-embedding-loading = Einbettungsmodell wird in den Speicher geladen...
setup-step-embedding-loaded = Einbettungsmodell geladen
...
setup-openai-embedding-testing = Einbettungs-Endpunkt wird getestet...
setup-openai-embedding-working = Einbettungs-Endpunkt funktioniert
setup-openai-embedding-failed = Einbettungstest fehlgeschlagen: { $error }

setup-azure-error-api-key-required = API-Schlüssel erforderlich
setup-azure-error-endpoint-required = Endpunkt erforderlich
setup-azure-error-deployment-required = Bereitstellung erforderlich
...
setup-azure-embedding-testing = Einbettung wird getestet...
setup-azure-embedding-working = Einbettung funktioniert
setup-azure-embedding-failed = Einbettung fehlgeschlagen: { $error }
