...
setup-step-embedding-warmup-failed-non-fatal = Falha no aquecimento (não fatal): { $error }
...
setup-openai-error-cannot-reach = Não foi possível alcançar a OpenAI: { $error }
...
setup-azure-error-cannot-reach = Não foi possível alcançar o endpoint do Azure: { $error }
