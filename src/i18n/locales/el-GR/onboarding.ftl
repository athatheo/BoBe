...
setup-step-model-pulling = Γίνεται pull του { $model }
setup-step-model-ready = Το μοντέλο { $model } είναι έτοιμο
setup-step-vision-model-pull-failed-non-fatal = Το pull του vision model απέτυχε (μη κρίσιμο): { $error }
setup-step-embedding-loading = Φόρτωση του embedding model στη μνήμη...
setup-step-embedding-loaded = Το embedding model φορτώθηκε
...
setup-openai-embedding-testing = Έλεγχος embedding endpoint...
setup-openai-embedding-working = Το embedding endpoint λειτουργεί
setup-openai-embedding-failed = Η δοκιμή embedding απέτυχε: { $error }

setup-azure-error-api-key-required = Απαιτείται κλειδί API
setup-azure-error-endpoint-required = Απαιτείται endpoint
setup-azure-error-deployment-required = Απαιτείται deployment name
setup-azure-validation-endpoint-validated = Το Azure endpoint επαληθεύτηκε
...
setup-azure-error-cannot-reach = Δεν είναι δυνατή η σύνδεση με το Azure endpoint: { $error }
