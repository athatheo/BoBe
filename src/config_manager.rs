...
static LLM_API_KEY_FIELDS: &[&str] = &["openai_api_key", "azure_openai_api_key", "anthropic_api_key"];
...
fn apply_changes(config: &mut Config, changes: &HashMap<String, serde_json::Value>) {
    ...
    for (key, value) in changes {
        ...
        match key.as_str() {
            ...
            "capture_interval_seconds" => parse_and_set!(config.capture_interval_seconds, str_val, key),
            ...
            "goal_check_interval_seconds" => parse_and_set!(config.goal_check_interval_seconds, str_val, key),
            "conversation_inactivity_timeout_seconds" => parse_and_set!(config.conversation_inactivity_timeout_seconds, str_val, key),
            "conversation_auto_close_minutes" => parse_and_set!(config.conversation_auto_close_minutes, str_val, key),
            "conversation_summary_enabled" => parse_and_set!(config.conversation_summary_enabled, str_val, key),
            ...
            "tools_preselector_enabled" => parse_and_set!(config.tools_preselector_enabled, str_val, key),
            "tools_allowed_file_dirs" => config.tools_allowed_file_dirs = str_val,
            "decision_cooldown_minutes" => parse_and_set!(config.decision_cooldown_minutes, str_val, key),
            "decision_extended_cooldown_minutes" => parse_and_set!(config.decision_extended_cooldown_minutes, str_val, key),
            "min_context_for_decision" => parse_and_set!(config.min_context_for_decision, str_val, key),
            "semantic_search_limit" => parse_and_set!(config.semantic_search_limit, str_val, key),
            "recent_ai_messages_limit" => parse_and_set!(config.recent_ai_messages_limit, str_val, key),
            ...
            "mcp_config_file" => {
                config.mcp_config_file = if str_val.is_empty() { None } else { Some(str_val) };
            }
            ...
            "goals_sync_interval_minutes" => parse_and_set!(config.goals_sync_interval_minutes, str_val, key),
            // Learning
            "learning_enabled" => parse_and_set!(config.learning_enabled, str_val, key),
            "learning_interval_minutes" => parse_and_set!(config.learning_interval_minutes, str_val, key),
            "learning_min_context_items" => parse_and_set!(config.learning_min_context_items, str_val, key),
            "learning_max_context_per_cycle" => parse_and_set!(config.learning_max_context_per_cycle, str_val, key),
            "learning_max_memories_per_cycle" => parse_and_set!(config.learning_max_memories_per_cycle, str_val, key),
            "learning_max_goals_per_cycle" => parse_and_set!(config.learning_max_goals_per_cycle, str_val, key),
            "learning_max_memories_per_consolidation" => parse_and_set!(config.learning_max_memories_per_consolidation, str_val, key),
            "daily_consolidation_enabled" => parse_and_set!(config.daily_consolidation_enabled, str_val, key),
            "daily_consolidation_hour" => parse_and_set!(config.daily_consolidation_hour, str_val, key),
            // Similarity thresholds
            "similarity_deduplication_threshold" => parse_and_set!(config.similarity_deduplication_threshold, str_val, key),
            "similarity_search_recall_threshold" => parse_and_set!(config.similarity_search_recall_threshold, str_val, key),
            "similarity_clustering_threshold" => parse_and_set!(config.similarity_clustering_threshold, str_val, key),
            // Retention
            "memory_raw_context_retention_days" => parse_and_set!(config.memory_raw_context_retention_days, str_val, key),
            "memory_short_term_retention_days" => parse_and_set!(config.memory_short_term_retention_days, str_val, key),
            "memory_long_term_retention_days" => parse_and_set!(config.memory_long_term_retention_days, str_val, key),
            ...
            "coding_agent_poll_interval_seconds" => parse_and_set!(config.coding_agent_poll_interval_seconds, str_val, key),
            "coding_agent_max_concurrent" => parse_and_set!(config.coding_agent_max_concurrent, str_val, key),
            "coding_agent_max_runtime_seconds" => parse_and_set!(config.coding_agent_max_runtime_seconds, str_val, key),
            // Goal worker
            "goal_worker_enabled" => parse_and_set!(config.goal_worker_enabled, str_val, key),
            "goal_worker_max_concurrent" => parse_and_set!(config.goal_worker_max_concurrent, str_val, key),
            "goal_worker_poll_interval_seconds" => parse_and_set!(config.goal_worker_poll_interval_seconds, str_val, key),
            "goal_worker_plan_max_steps" => parse_and_set!(config.goal_worker_plan_max_steps, str_val, key),
            "goal_worker_step_max_turns" => parse_and_set!(config.goal_worker_step_max_turns, str_val, key),
            "goal_worker_autonomous" => parse_and_set!(config.goal_worker_autonomous, str_val, key),
            "goal_worker_ask_user_timeout_seconds" => parse_and_set!(config.goal_worker_ask_user_timeout_seconds, str_val, key),
            "goal_worker_approval_timeout_minutes" => parse_and_set!(config.goal_worker_approval_timeout_minutes, str_val, key),
            "goal_worker_max_failure_retries" => parse_and_set!(config.goal_worker_max_failure_retries, str_val, key),
